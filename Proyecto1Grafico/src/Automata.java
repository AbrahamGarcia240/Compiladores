...
public class Automata {
    ...
    */
    ...
    //MenuPrincipal.jTextArea.append("Holi");
    
        for(Map.Entry<Integer, Estado> e: this.Estados.entrySet()){  //para cada estado del automata
            //Imprime el automata el jTextArea1
            printAutomata.jTextArea2.append(Integer.toString(e.getValue().getId())  );            
        ...
        try {
                    printAutomata.jTextArea2.append(""+this.getEstadoInicial().getId());
        ...
        try 
        {            
            this.getEstadoFinal().forEach(n->printAutomata.jTextArea2.append("" + n.getId())); //System.out.println(n.getId()));
        } catch (Exception e) {
            System.out.println(e);
        }
       printAutomata.jTextArea2.append("\n");
